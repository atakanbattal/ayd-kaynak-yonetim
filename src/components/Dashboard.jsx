        ...
        <DialogContent className="sm:max-w-[600px] bg-white rounded-xl shadow-2xl p-0 overflow-hidden border-0">
          <DialogHeader className="bg-gradient-to-r from-blue-600 to-blue-500 p-6 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-xl font-bold text-white">Genel Yönetici Raporu - Tarih Aralığı Seçimi</DialogTitle>
          ...
          <DialogFooter className="p-6 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3">
            <Button variant="outline" className="rounded-lg" onClick={() => setShowReportDialog(false)}>
              İptal
            </Button>
            <Button
